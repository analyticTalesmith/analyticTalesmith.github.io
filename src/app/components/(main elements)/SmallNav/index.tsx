...
function TestNav({ links }: { links: linkData[]}) {
    ...
    return (
        <div>
            <button className={`float-left p-4 z-100 relative group md:hidden`}
                    onClick={toggleNav}>
            ...
            {nav && (
                ...
                <ul className="fixed inset-0 z-100 font-spaceGrotesk flex flex-col justify-center items-center bg-gradient-to-b from-primary-container to-tertiary-container md:hidden">
