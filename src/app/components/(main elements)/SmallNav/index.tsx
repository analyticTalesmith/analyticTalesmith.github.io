    ...
    return (
        <div>
            ...
            {nav && (
                ...
                <ul className="fixed inset-0 z-10 font-spaceGrotesk flex flex-col justify-center items-center bg-gradient-to-b from-primary-container to-tertiary-container md:hidden">
